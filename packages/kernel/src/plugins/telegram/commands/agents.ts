 ...
 */
export async function handleAgents(ctx: Context, core: VibenCore, page = 0): Promise<void> {
  ...
  if (available.length > 0) {
    ...
    if (available.some((i) => !i.available)) {
      text += "\n💡 <i>Agents marked ⚠️ need additional setup. Use</i> <code>viben agents info &lt;name&gt;</code> <i>for details.</i>\n";
    }
...
export async function handleAgentCallback(ctx: Context, core: VibenCore): Promise<void> {
