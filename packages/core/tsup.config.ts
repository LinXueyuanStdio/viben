...
export default defineConfig({
  ...
  // Note: unzipper and archiver are external for pet import/export (dynamically imported)
  external: ["fastify", "@fastify/cors", "@fastify/websocket", "node-pty", "ws", "yaml", "unzipper", "archiver"],
