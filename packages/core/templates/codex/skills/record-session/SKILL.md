...
cat << 'EOF' | python3 ./.viben/scripts/add_session.py --title "Title" --commit "hash"
| Feature | Description |
|---------|-------------|
...
```bash
python3 ./.viben/scripts/task.py archive <task-name>
```
...
| Command | Purpose |
|---------|---------|
| `python3 ./.viben/scripts/get_context.py` | Get all context info |
| `python3 ./.viben/scripts/add_session.py --title "..." --commit "..."` | **One-click add session (recommended)** |
| `python3 ./.viben/scripts/task.py create "<title>" [--slug <name>]` | Create new task directory |
| `python3 ./.viben/scripts/task.py archive <name>` | Archive completed task |
