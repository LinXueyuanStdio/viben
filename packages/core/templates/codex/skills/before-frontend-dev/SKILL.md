...
Execute these steps:
1. Read `docs/specs/frontend/index.md` to understand available guidelines
2. Based on your task, read the relevant guideline files:
   - Component work → `docs/specs/frontend/component-guidelines.md`
   - Hook work → `docs/specs/frontend/hook-guidelines.md`
   - State management → `docs/specs/frontend/state-management.md`
   - Type questions → `docs/specs/frontend/type-safety.md`
