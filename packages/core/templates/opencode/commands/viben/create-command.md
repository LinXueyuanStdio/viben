...
Create a new slash command in both `.cursor/commands/` (with `viben-` prefix) and `.opencode/commands/viben/` directories based on user requirements.
...
- `.opencode/commands/viben/<command-name>.md`
