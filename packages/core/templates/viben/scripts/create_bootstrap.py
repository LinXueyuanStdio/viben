...
after initializing Viben for the first time.
...
Prerequisites:
    - .viben/.developer must exist (run init_developer.py first)
...
def write_task_json(task_dir: Path, developer: str, project_type: str) -> None:
    ...
    if project_type == "frontend":
        ...
        related_files = [".viben/spec/frontend/"]
    elif project_type == "backend":
        subtasks = [
            {"name": "Fill backend guidelines", "status": "pending"},
            {"name": "Add code examples", "status": "pending"},
        ]
        related_files = [".viben/spec/backend/"]
    else:  # fullstack
        subtasks = [
            {"name": "Fill backend guidelines", "status": "pending"},
            {"name": "Fill frontend guidelines", "status": "pending"},
        ...
        related_files = [".viben/spec/backend/", ".viben/spec/frontend/"]
    ...
    task_data = {
        ...
        "notes": f"First-time setup task created by viben init ({project_type} project)",
    }
