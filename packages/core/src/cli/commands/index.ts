...
const COMMANDS: CommandMeta[] = [
  ...
  { name: "auth", description: "Authenticate with Viben Web", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerAuthCommand })) },
  { name: "profile", description: "Manage Viben Web profile", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerProfileCommand })) },
  { name: "api-key", description: "Manage Viben Web API keys", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerApiKeyCommand })) },
  { name: "mcp-market", description: "Browse MCP packages on Viben Web", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerMcpMarketCommand })) },
  { name: "skill-market", description: "Browse Skill packages on Viben Web", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerSkillMarketCommand })) },
  { name: "collection", description: "Manage Viben Web collections", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerCollectionsCommand })) },
  { name: "favorites", description: "List Viben Web favorites", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerFavoritesCommand })) },
  { name: "voice", description: "Get LiveKit voice token", loader: () => import("@viben/api-client/commands").then(m => ({ register: m.registerVoiceCommand })) },
