...
import { registerAgentAcpRoutes } from "./agent-acp";
...
import { registerBrowsePluginsRoutes } from "./browse-plugins";
...
export async function registerRoutes(fastify: FastifyInstance, state: AppState): Promise<void> {
  ...
  registerInputHistoryRoutes(fastify);
  ...
  registerBrowsePluginsRoutes(fastify);
...
export { registerInputHistoryRoutes } from "./input-history";
...
export { registerAgentAcpRoutes, getActiveAcpSessionCount, closeAllAcpSessions } from "./agent-acp";
...
export { registerBrowsePluginsRoutes, getBrowsePluginsDir } from "./browse-plugins";
export type { BrowsePluginRegistryEntry, InstalledBrowsePlugin } from "./browse-plugins";
