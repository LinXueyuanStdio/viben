 ...
 * When an agent config includes mcpServers: ["client_side", ...],
...
// so side-effect imports at the bottom of this
 ...
 *
 * - String entries: looked up in the in-process registry (e.g., "client_side")
...
import "./sdk-mcp-servers/client-side-mcp-server";
