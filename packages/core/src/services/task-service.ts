...
export { TaskEventType, VALID_EVENT_TYPES, isValidEventType } from "../task/events/event-types";

// Re-export status constants and validation
export { VALID_TASK_STATUSES, isValidTaskStatus } from "../task/ops/types";
...
import { isValidTaskStatus } from "../task/ops/types";
