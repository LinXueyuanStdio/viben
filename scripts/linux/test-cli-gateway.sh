#!/usr/bin/env bash
#
# Viben Bundled CLI + Gateway Test Script (Linux)
#
# Tests the Bun-compiled standalone binary (sidecar) on Linux.
# Must pass before the desktop release proceeds.
#
# Usage:
#   ./scripts/linux/test-cli-gateway.sh <path-to-binary>
#
# Example:
...
echo ""
echo -e "${CYAN}${BOLD}  Viben Bundled CLI Test (Linux)${NC}"
