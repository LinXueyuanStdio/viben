 ...
 *
 * Displays PowerPoint presentations (pptx, ppt, odp).
 * Since parsing these formats requires additional dependencies (jszip),
    ...
    <div className="bg-muted/20 flex h-full flex-col items-center justify-center p-8">
      <div className="flex max-w-md flex-col items-center text-center">
        ...
        <p className="text-muted-foreground mb-6 text-sm">
          {t("artifacts.pptxPreview.description")}
        </p>
        <button
        ...
        >
          ...
          {t("artifacts.pptxPreview.openButton")}
        </button>
      </div>
    </div>
  );
