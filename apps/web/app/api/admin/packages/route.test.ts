...
describe('GET /api/admin/packages', () => {
  ...
  it('returns 401 when requirePermission rejects with status 401', async () => {
    ...
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages');
  ...
  it('passes type filter', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?type=mcp');
    await GET(request);
    expect(mocks.listPackagesForReview).toHaveBeenCalledWith(expect.objectContaining({ type: 'mcp' }));
  });

  it('passes status filter', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?status=approved');
    await GET(request);
  ...
  it('passes page and limit params', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?page=2&limit=10');
    await GET(request);
  ...
  it('passes sort param', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?sort=newest');
    await GET(request);
  ...
  it('passes all params combined', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?type=skill&status=featured&page=3&limit=50&sort=newest');
    await GET(request);
  ...
  it('returns 400 for invalid status value', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?status=invalid');
    const response = await GET(request);
    const json = await response.json();
  ...
  it('returns 400 for invalid type value', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?type=invalid');
    const response = await GET(request);
    const json = await response.json();
    expect(response.status).toBe(400);
    expect(json.error).toBe('Invalid query parameters');
  ...
  it('returns 400 for page less than 1', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?page=0');
    const response = await GET(request);
    const json = await response.json();
    expect(response.status).toBe(400);
    expect(json.error).toBe('Invalid query parameters');
  ...
  it('returns 400 for limit exceeding 100', async () => {
    const request = new NextRequest('https://viben-web.vercel.app/api/admin/packages?limit=200');
    const response = await GET(request);
    const json = await response.json();
    expect(response.status).toBe(400);
    expect(json.error).toBe('Invalid query parameters');
