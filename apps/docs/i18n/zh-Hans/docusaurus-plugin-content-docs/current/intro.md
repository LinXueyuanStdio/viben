...
sidebar_position: 1
title: "微本简介"
description: "微本 - 多智能体工作空间管理器，集成看板、日历、时间线和任务管理"
---

# 微本

**微本** 是一个多智能体工作空间管理器，帮助你统一管理 AI 助手、MCP 服务器和开发任务。无论你使用 Claude Code、Cursor、Codex 还是其他 AI 编程助手，微本都能让你在一个地方管理所有配置和任务。
...
在深入了解功能之前，建议先理解微本的核心概念。详见 [核心概念](getting-started/concepts)。
...
微本 Gateway 是核心后端服务，运行在端口 **18790**，提供：
