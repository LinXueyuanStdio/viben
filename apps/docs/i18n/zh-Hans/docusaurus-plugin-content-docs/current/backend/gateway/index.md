...
> HTTP/WebSocket API server providing AI agent orchestration and management services.
...
│   ├── /ws/agent/acp                            ACP Agent WebSocket (JSON-RPC 2.0)
│   ├── /ws/agent/run                            Agent Run WebSocket
│   ├── /api/group-chats/:id/sessions/:sid/ws    Group Chat WebSocket
...
| Logging | Pino + OpenTelemetry | Structured request/response logging |
...
| Sandbox | `/api/sandbox` | [sandbox.md](./sandbox.md) |
...
| WebSocket | `/ws` | [websocket.md](./websocket.md) |
...
- [ACP WebSocket 协议](./acp.md) — ACP JSON-RPC 2.0 协议
- [Sandbox 执行](./sandbox.md) — 沙箱代码执行
