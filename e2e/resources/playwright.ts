...
export const playwrightUiScenarios: UiScenario[] = [
  ...
  },
  {
    ...
    mockArtifact: {
      ...
      html:
        '<!doctype html><html><body><main data-viben-id="hero-section"><h1 data-viben-id="hero-title" data-screen-label="Hero title">Prototype headline</h1><p data-viben-id="hero-copy">Preview copy for comment mode.</p></main></body></html>',
    },
    notes: [
