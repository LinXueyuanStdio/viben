...
cat .viben/spec/unit-test/index.md # Testing guidelines
```
...
Task(
  ...
  Please find:
  1. Relevant code-spec files in .viben/spec/
...
If `viben task context` shows a current task:
...
| `viben task init-context <task> -t <type>` | Initialize jsonl files |
